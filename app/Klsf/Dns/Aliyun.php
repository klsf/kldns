...
{
    use DnsHttp;
    private $url = "https://alidns.aliyuncs.com/";
    private $method = "POST";
    private $accessKeyId;
    ...
    function configInfo()
    {
        return [
            [
                ...
                'tips' => '<a href="https://www.alibabacloud.com/help/zh/dns/api-alidns-2015-01-09-overview" target="_blank">查看阿里云 DNS OpenAPI 文档</a>'
            ],
            [
